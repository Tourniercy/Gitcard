...
export const flatTheme: Theme = {
  ...
  backgroundBlur: 'rgba(255, 255, 255, 1)',
  border: '#e5e7eb',
  title: '#111827',
  text: '#374151',
  muted: '#9ca3af',
...
export const breezyTheme: Theme = {
  ...
  backgroundBlur: 'rgba(240, 249, 255, 0.5)',
...
export const roseTheme: Theme = {
  ...
  backgroundBlur: 'rgba(255, 241, 242, 0.5)',
...
export const mintTheme: Theme = {
  ...
  backgroundBlur: 'rgba(236, 253, 245, 0.5)',
...
export const sandTheme: Theme = {
  ...
  backgroundBlur: 'rgba(255, 251, 235, 0.5)',
...
export const lavenderTheme: Theme = {
  ...
  backgroundBlur: 'rgba(245, 243, 255, 0.5)',
...
export const dimTheme: Theme = {
  ...
  backgroundBlur: 'rgba(34, 39, 46, 0.5)',
...
export const midnightTheme: Theme = {
  ...
  backgroundBlur: 'rgba(15, 23, 42, 0.5)',
...
export const monokaiTheme: Theme = {
  ...
  backgroundBlur: 'rgba(39, 40, 34, 0.5)',
...
export const nordTheme: Theme = {
  ...
  backgroundBlur: 'rgba(46, 52, 64, 0.5)',
...
export const solarizedTheme: Theme = {
  ...
  backgroundBlur: 'rgba(253, 246, 227, 0.5)',
...
export const solarizedDarkTheme: Theme = {
  ...
  backgroundBlur: 'rgba(0, 43, 54, 0.5)',
...
export const gruvboxTheme: Theme = {
  ...
  backgroundBlur: 'rgba(40, 40, 40, 0.5)',
...
export const gruvboxLightTheme: Theme = {
  ...
  backgroundBlur: 'rgba(251, 241, 199, 0.5)',
...
export const tokyoNightTheme: Theme = {
  ...
  backgroundBlur: 'rgba(26, 27, 38, 0.5)',
...
export const oneDarkTheme: Theme = {
  ...
  backgroundBlur: 'rgba(40, 44, 52, 0.5)',
...
export const oneLightTheme: Theme = {
  ...
  backgroundBlur: 'rgba(250, 250, 250, 0.5)',
...
export const catppuccinMochaTheme: Theme = {
  ...
  backgroundBlur: 'rgba(30, 30, 46, 0.5)',
...
export const catppuccinLatteTheme: Theme = {
  ...
  backgroundBlur: 'rgba(239, 241, 245, 0.5)',
...
export const synthwaveTheme: Theme = {
  ...
  backgroundBlur: 'rgba(36, 18, 59, 0.5)',
...
export const cobaltTheme: Theme = {
  ...
  backgroundBlur: 'rgba(0, 28, 54, 0.5)',
...
export const nightOwlTheme: Theme = {
  ...
  backgroundBlur: 'rgba(1, 22, 39, 0.5)',
...
export const auroraTheme: Theme = {
  ...
  backgroundBlur: 'rgba(7, 15, 43, 0.5)',
...
export const oceanTheme: Theme = {
  ...
  backgroundBlur: 'rgba(3, 28, 59, 0.5)',
...
export const forestTheme: Theme = {
  ...
  backgroundBlur: 'rgba(16, 36, 24, 0.5)',
...
export const sunsetTheme: Theme = {
  ...
  backgroundBlur: 'rgba(54, 17, 31, 0.5)',
...
export const cherryTheme: Theme = {
  ...
  backgroundBlur: 'rgba(45, 10, 20, 0.5)',
...
export const slateTheme: Theme = {
  ...
  backgroundBlur: 'rgba(30, 41, 59, 0.5)',
...
export const cottonCandyTheme: Theme = {
  ...
  backgroundBlur: 'rgba(253, 242, 248, 0.5)',
...
export const paperTheme: Theme = {
  ...
  backgroundBlur: 'rgba(250, 248, 240, 0.5)',
